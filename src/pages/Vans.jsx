...
createServer({
    ...
    seeds(server) {
        ...
        server.create("van", { id: "2", name: "Beach Bum", price: 80, description: "Beach Bum is a van inspired by surfers and travelers. It was created to be a portable home away from home, but with some cool features in it you won't find in an ordinary camper.", 
...
const Vans = () => {
  ...
  return (
                <div className="van-list-container">
                    ...
                    <Link to="?type=luxury" className="van-type simple">Luxury</Link>
                    <Link to="?type=rugged" className="van-type simple">Rugged</Link>
                    <Link to="." className="van-type simple">Clear filters</Link>
                    </div>
